      ...
      <div className="site-container">
        ...
        <div className="grid gap-8 lg:grid-cols-12 lg:gap-10">
          <div className="space-y-6 lg:col-span-8">
            <div className="flex flex-col gap-5 rounded-[2rem] border border-[#7FB5EA] bg-[#DCEEFF] p-6 shadow-sm sm:flex-row sm:items-center sm:p-8">
              <span
              ...
              <div className="space-y-2">
                ...
                <h1 className="text-4xl font-semibold tracking-tight text-slate-950 md:text-5xl">{service.title}</h1>
                <p className="text-lg leading-8 text-slate-600">{service.shortDescription}</p>
              </div>
            </div>

            <div className="rounded-[1.75rem] border border-[#7FB5EA] bg-[#DCEEFF] p-6 shadow-sm sm:p-8">
            ...
            <div className="rounded-[1.75rem] border border-[#7FB5EA] bg-[#DCEEFF] p-6 shadow-sm sm:p-8">
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-2">
                {service.features.map((feature) => (
                  <div key={feature} className="flex items-start gap-3 rounded-xl border border-[#7FB5EA] bg-[#C6E0FF] px-4 py-4">
            ...
            <div className="rounded-[1.75rem] border border-[#7FB5EA] bg-[#DCEEFF] p-6 shadow-sm sm:p-8">
              ...
              <div className="mt-6 space-y-4">
                {service.benefits.map((benefit) => (
                  <div key={benefit} className="flex items-start gap-3 rounded-xl border border-[#7FB5EA] bg-[#DCEEFF] px-4 py-4">
          ...
          <div className="lg:col-span-4">
            <div className="space-y-6 lg:sticky lg:top-28">
              <div className="rounded-[1.75rem] border border-[#1B66B3] bg-[#C6E0FF] p-6 shadow-sm">
                <h3 className="text-2xl font-semibold text-slate-950">Ready to get started?</h3>
              ...
              <div className="rounded-[1.75rem] border border-[#7FB5EA] bg-[#DCEEFF] p-6 shadow-sm">
                <h4 className="text-lg font-semibold text-slate-950">Related services</h4>
                <div className="mt-4 space-y-3">
                  {relatedServices.map((item) => (
                    <Link
                      key={item.id}
                      href={`/services/${item.id}`}
                      className="block rounded-xl border border-[#7FB5EA] bg-[#DCEEFF] px-4 py-4 transition-colors hover:bg-[#CFE3FF]"
                    >
                      <div className="flex items-center gap-3">
                        <span className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#C6E0FF] text-[#1B66B3]">
                          <item.icon className="h-4 w-4" />
                        </span>
                        <div className="min-w-0">
                          <p className="text-sm font-semibold text-slate-900">{item.title}</p>
                          <p className="mt-1 text-xs leading-5 text-slate-600">{item.shortDescription}</p>
                        </div>
                      </div>
                    </Link>
                  ))}
